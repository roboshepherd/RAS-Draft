...
\centering
\subfloat[Series A]
{\includegraphics[width=0.48\linewidth, angle=0]
...
\newline
\subfloat[Series C]
{\includegraphics[width=0.42\linewidth, angle=0]
...
\centering
\hspace*{0.5cm}
\subfloat[Series C]{\includegraphics[height=8cm]{images/Robot12-16feb-1-LocalSignals.eps}}
\newline
\subfloat[Series D]{\includegraphics[height=8cm]{images/Robot12-17feb-3-LocalSignals.eps}}
