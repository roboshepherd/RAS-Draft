...
\begin{figure*}
\begin{center}
\includegraphics[width=0.8\linewidth,height=10cm]{./images/concrete-arch} 
%\centering
...
\begin{figure*}
\centering
\includegraphics[width=0.8\linewidth,height=10cm]
...
\begin{figure*}
\centering
\includegraphics[width=0.8\linewidth,height=11cm]
...
\begin{centering}
\subfloat[Series C]{\includegraphics[width=0.8\linewidth]{images/Robot12-16feb-1-LocalSignals.eps}}
\newline
\subfloat[Series D]{\includegraphics[width=0.8\linewidth]{images/Robot12-17feb-3-LocalSignals.eps}}
