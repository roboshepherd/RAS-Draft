...
%%
\section{A Three-Dimensional Taxonomy of MRTA Systems}
\label{sec:taxonomy}
%%
In order to categorize both explicit and self-organized MRTA approaches we propose three distinct dimensions: 1) organization of task-allocation, 2) degree of interaction and 3) degree of communication.  Fig. \ref{fig:mrta-complexities} depicts these dimensions.  This taxonomy can be used to measure the complexities involved in various kinds of MRTA problems and to facilcilitated the design of appropriate systems form handling them.
...
\begin{tabular}{|p{0.28in}|p{0.8in}|p{0.8in}|p{0.8in}|p{0.8in}|}
...
\begin{tabular}{|p{0.3in}|p{0.7in}|p{0.7in}|c|p{0.7in}|}
